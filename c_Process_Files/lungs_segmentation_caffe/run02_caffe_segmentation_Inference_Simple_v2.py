    ...
    def loadMeanInfo(self, newShape=None):
        ...
        with open(path_mean_proto,'rb') as f:
            ...
            if newShape is not None:
                ...
                # tarrMean = sktf.resize(tarrMean, newShape, order=1)
...
if __name__=='__main__':
    if len(sys.argv)<3:
        ...
        sys.exit(1)
    # pathToDigitsJobDir_with_Model   = '/home/ar/github.com/NVIDIA/DIGITS.git/digits/jobs/20170214-161816-7de1'
    # pathDirWithImages               = '/home/ar/github.com/NVIDIA/DIGITS.git/examples/semantic-segmentation/voc-data/val/images_png'
